...
class IcebergView(BaseModel):
    @classmethod
    def from_pyiceberg(cls, name: str, owners: Optional[EntityReferenceList], view: pyiceberg.view.View) -> IcebergTable:
        return IcebergTable(
            name=name,
            tableType=TableType.View,
            description=view.metadata.properties.get("comment"),
            owners=owners,
